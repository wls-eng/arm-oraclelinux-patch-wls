...
ExecStart="/u01/domains/$wlsDomainName/bin/startNodeManager.sh"
ExecStop="/u01/domains/$wlsDomainName/bin/stopNodeManager.sh"
User=oracle
Group=oracle
KillMode=process
LimitNOFILE=65535
...
echo "Updating patch to latest kernel available"
update_patch
